...
VALUES
    ...
    (
        1,
        1,
        '¿En qué región está la Patagonia?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 3
    (
        1,
        1,
        '¿Cuál es el pico más alto del país?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 4
    (
        1,
        1,
        '¿Qué río marca gran parte de la frontera con Uruguay?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 5
    ...
    (
        1,
        1,
        '¿Cuál es el mayor lago argentino en superficie total (compartido con Chile)?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 7
    (
        1,
        1,
        '¿Qué provincia es famosa por su “Quebrada de Humahuaca”?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 8
    (
        1,
        1,
        '¿Cuál es la ciudad más austral del país?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 9
    (
        1,
        1,
        '¿Qué sierras atraviesan gran parte de Córdoba?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 10
    (
        1,
        1,
        '¿Cuál es el principal río que cruza la ciudad de Buenos Aires?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- Cine
    ...
    (
        6,
        1,
        '¿De qué saga es el personaje “Harry Potter”?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 13
    (
        6,
        1,
        '¿Qué película popularizó la frase “I’ll be back”?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 14
    (
        6,
        1,
        '¿Qué premio entrega la Academia de Hollywood?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 15
    (
        6,
        1,
        '¿Quién interpretó a Jack en Titanic?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 16
    (
        6,
        1,
        '¿Qué película animada presenta a “Woody y Buzz”?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 17
    (
        6,
        1,
        '¿Qué director es conocido por Inception y The Dark Knight?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 18
    (
        6,
        1,
        '¿Cuál es un famoso estudio de animación?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 19
    (
        6,
        1,
        '¿Qué país es cuna del “Bollywood”?',
        'facil',
        '2025-09-25 16:09:32'
    ),
    -- 20
...
VALUES
    ...
    (
        1,
        11,
        'Sierras de Córdoba (Comechingones/Sierras Chicas)',
        true
    ),
...
-- partida_jugadores
INSERT INTO
    `partida_jugadores` (`partida_id`, `jugador_id`)
VALUES
    (1, 1),
    (2, 1),
    (3, 1);
...
VALUES
    (1, 2, 'en_curso', '2025-10-31 00:09:32') -- sala_jugadores
INSERT INTO
    `sala_jugadores`(`sala_id`, `jugador_id`, `joined_at`)
VALUES
    -- jugador 1
    (2, 1, '2025-10-31 00:09:35'),
    -- jugador 2
    (2, 9, '2025-10-31 00:010:35');
...
VALUES
    (1, 4, 1, 1000, 8, 2, 600000),
    (6, 4, 0, 500, 7, 3, 580000);
...
VALUES
    ...
    -- jugador 1
    -- respuesta 1
    (4, 1, 3, 11, 11, 4, 1, 15000),
    -- respuesta 2
    (4, 1, 4, 12, 13, 4, 0, 20000),
    -- respuesta 3
    (4, 1, 5, 13, 19, 4, 1, 30000),
    -- respuesta 4
    (4, 1, 6, 14, 22, 4, 1, 20000),
    -- respuesta 5
    (4, 1, 7, 15, 25, 4, 0, 50000),
    -- respuesta 6
    (4, 1, 8, 16, 30, 4, 1, 20000),
    -- respuesta 7
    (4, 1, 9, 17, 34, 4, 1, 15000),
    -- respuesta 8
    (4, 1, 10, 18, 37, 4, 0, 55000),
    -- respuesta 9
    (4, 1, 11, 19, 42, 4, 0, 45000),
    -- respuesta 10
    (4, 1, 12, 20, 45, 4, 0, 52000),

    -- jugador 2
    -- respuesta 1
    (4, 6, 3, 11, 11, 4, 1, 15000),
    -- respuesta 2
    (4, 6, 4, 12, 13, 4, 0, 20000),
    -- respuesta 3
    (4, 6, 5, 13, 19, 4, 1, 30000),
    -- respuesta 4
    (4, 6, 6, 14, 22, 4, 1, 20000),
    -- respuesta 5
    (4, 6, 7, 15, 25, 4, 0, 50000),
    -- respuesta 6
    (4, 6, 8, 16, 30, 4, 1, 20000),
    -- respuesta 7
    (4, 6, 9, 17, 34, 4, 1, 15000),
    -- respuesta 8
    (4, 6, 10, 18, 37, 4, 0, 55000),
    -- respuesta 9
    (4, 6, 11, 19, 42, 4, 0, 45000),
    -- respuesta 10
    (4, 6, 12, 20, 45, 4, 0, 52000);