  ...
  const Login = () => {
    ...
    return (
      <div
        className="w-90 h-130 bg-amber-600 rounded-3xl p-6 mt-4 mb-4 text-center">
        ...
        <form onSubmit={handleSubmit}>
          <div className=' bg-amber-200  rounded-4xl flex flex-col text-center items-center justify-center text-black'>
            ...
            <div className='flex-col items-center justify-center mb-1 p-1'>
              <label htmlFor="email"><strong>Ingrese Email</strong></label>
              <input type="text" required name="email" placeholder='Ingrese email o usuario' onChange={handleChanges} className="w-70 h-15  rounded-4xl text-center bg-amber-100 hover:bg-amber-200 placeholder-gray-500 text-black" />
            </div>
            <div className='flex-col items-center justify-center m-1 p-1'>
              <label htmlFor="password"><strong>Ingrese Contraseña</strong></label>
              <input type="password"  required name="password" placeholder='Ingrese contraseña' onChange={handleChanges} className="w-70 h-15 rounded-4xl  text-center bg-amber-100 hover:bg-amber-200 placeholder-gray-500 text-black" />
            </div>
